...
/**
 * Chat→vocab bulk extraction. The button scans the WHOLE conversation
 * (LLM online, VOCAB-line mock offline) and opens a review dialog — the
 * learner picks which candidates join their list, extraction itself
 * saves nothing.
 */
export function ExtractVocabButton({ threadId }: { threadId: string }) {

 ...
 */
export async function PortalContent({
  student,
  teacherName,
  token,
}: {
      ...
      <section className="mb-8 space-y-3">
        {vocabulary.length > 0 && (
          <Link
            ...
            className="flex items-center gap-3 rounded-lg bg-surface px-4 py-3.5 shadow-card transition-colors hover:bg-surface-hover"
          >

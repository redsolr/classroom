CREATE TYPE "public"."lesson_call_role" AS ENUM('teacher', 'learner');--> statement-breakpoint
...
CREATE TABLE "lesson_calls" (
	...
	"learner_consent_at" timestamp with time zone,
...
--> statement-breakpoint
ALTER TABLE "lesson_calls" ADD CONSTRAINT "lesson_calls_booking_id_tutor_bookings_id_fk" FOREIGN KEY ("booking_id") REFERENCES "public"."tutor_bookings"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "lesson_calls" ADD CONSTRAINT "lesson_calls_learner_id_learners_id_fk" FOREIGN KEY ("learner_id") REFERENCES "public"."learners"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "lesson_calls_booking_idx" ON "lesson_calls" USING btree ("booking_id");--> statement-breakpoint
CREATE INDEX "lesson_calls_teacher_idx" ON "lesson_calls" USING btree ("teacher_id");--> statement-breakpoint
CREATE INDEX "lesson_calls_learner_idx" ON "lesson_calls" USING btree ("learner_id");--> statement-breakpoint
